...
let kilometersToTheMoon: number = 38440;
...
// // console.log(`Determination would take ${daysToMars} days to get to Mars.`);
...
// Move your output statemen t from part 2 here. Update the template literal to call
